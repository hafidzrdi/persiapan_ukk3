...
<head>
    ...
    <title>Ardtech Technology</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Jago Koding</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a href="{{ route('siswa.index') }}" class="collapse-item" href="cards.html">Siswa</a>
                        <a href="{{ route('barang.index') }}" class="collapse-item" href="cards.html">Barang</a>
                        <a href="{{ route('barangg.index') }}" class="collapse-item" href="cards.html">Barang 2.0</a>
